...
MapDH::~MapDH(){
	...
	int MapDH::hash_1(string k){ //acumulacion polinomial para cada caracter
		long long int sum=0;
	...
	int MapDH::hash_2(string k){ //acumulacion polinomial para cada 2 caracteres
		long long int sum=0;
...
/*
unsigned long MapDH::func_hash(string k){
	int k1=hash_1(k);
	int k2=hash_2(k);
	if()
...
int MapDH::getCols_ins(){
	return cols_ins;
}

int MapDH::getCols_at(){
	return cols_at;
}
